...
const About = () => {
    return (
        <div id='about' className='min-h-[50em] cursor-default'>
            <div className='max-w-[1000px] m-auto flex flex-col p-8 py-16'>
                <h1 data-aos='fade-right' className='text-4xl font-bold flex-1'>About Me:</h1>
                <div data-aos='fade-right' data-aos-delay='500' className='text-xl font-LT-Hoop-SemiBold'>
                    <p className='pt-4'>My name is Vincent DiGiovanni, I am a student at Rochester Institute of Technology, studying Computing and Information Technologies.</p>
                    ...
                    <h3 className='pt-8 text-xl font-LT-Hoop-Bold'>My resume is available for download below:</h3>
