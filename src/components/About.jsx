        ...
        <div id='about' className='mb-10 cursor-default'>
            <div className='max-w-[1500px] m-auto px-8'>
                ...
                <div data-aos='fade-right' data-aos-delay='500' className='text-xl'>
                    ...
                    <a className='bg-blue-500 text-white min-w-[200px] max-w-[250px] min-h-[50px] py-4 my-2 flex justify-center items-center shadow-md shadow-slate-600 hover:bg-blue-800 ease-in duration-100' href='/files/DiGiovanniV-Resume-2024.pdf'>
