        ...
        <div id='projects' className='bg-gray-100 cursor-default'>
            <div className='max-w-[1000px] m-auto px-8'>
                ...
                <div className='text-xl'>
                    <h3 className='text-2xl pb-5 font-MADE-TOMMY-Medium'>Personal Website</h3>
                ...
                <hr />
                <div className='text-xl py-5'>
                    <h3 className='text-2xl my-5 font-MADE-TOMMY-Medium'>Fuzz Pedal</h3>
                    <swiper-container navigation='true' pagination='true' speed='500' loop='true'>
                        <swiper-slide><img src='/images/projects/fuzz1.jpg' alt='Schematic of Maestro Fuzz-Tone FZ-1A' loading="lazy" /></swiper-slide>
                        <swiper-slide><img src='/images/projects/fuzz2.jpg' alt='Prototype fuzz circuit on breadboard' loading="lazy" /></swiper-slide>
                        <swiper-slide><img src='/images/projects/fuzz3.jpg' alt='Soldering fuzz circuit onto perforated board' loading="lazy" /></swiper-slide>
                        <swiper-slide><img src='/images/projects/fuzz4.jpg' alt='Fuzz circuit in 3D printed enclosure' loading="lazy" /></swiper-slide>
                    </swiper-container>
                    <ul className='my-5 ml-8 list-disc'>
